...
<body>
    ...
    <header class="sticky-top bg-dark text-white py-2" style="background-color: #000;">
        ...
        <ul class="menu">
            ...
            <li><a href="#">Tek Zone</a></li>
            <li><a href="#">Top Care</a></li>
        </ul>

        <!-- Icons -->
        <div class="icon-area">
            <div class="circle-btn"><i class="fas fa-search"></i></div>
            ...
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-md-between gap-3">
                ...
                <nav class="d-flex overflow-auto gap-3">
                    <a href="tainghe.php"
                        ...
                        cả</a>
                    <a href="?dong=tainghe"
                        class="btn btn-sm border-0 pb-1 <?= $dong == 'tainghe' ? 'text-white border-bottom border-white fw-semibold' : 'text-light' ?>">Tai
                        nghe</a>
                    <a href="?dong=loa"
                        class="btn btn-sm border-0 pb-1 <?= $dong == 'loa' ? 'text-white border-bottom border-white fw-semibold' : 'text-light' ?>">Loa</a>
                </nav>
