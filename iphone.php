            ...
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-md-between gap-3">
                ...
                <nav class="d-flex overflow-auto gap-3">
                    <a href="iphone.php"
                        ...
                        cả</a>
                    <a href="?dong=16"
                        class="btn btn-sm border-0 pb-1 <?= $dong == '16' ? 'text-white border-bottom border-white fw-semibold' : 'text-light' ?>">iPhone
                        16</a>
                    <a href="?dong=15"
                        class="btn btn-sm border-0 pb-1 <?= $dong == '15' ? 'text-white border-bottom border-white fw-semibold' : 'text-light' ?>">iPhone
                        15</a>
                    <a href="?dong=14"
                        class="btn btn-sm border-0 pb-1 <?= $dong == '14' ? 'text-white border-bottom border-white fw-semibold' : 'text-light' ?>">iPhone
                        14</a>
                    <a href="?dong=13"
                        class="btn btn-sm border-0 pb-1 <?= $dong == '13' ? 'text-white border-bottom border-white fw-semibold' : 'text-light' ?>">iPhone
                        13</a>
                    <a href="?dong=12"
                        class="btn btn-sm border-0 pb-1 <?= $dong == '12' ? 'text-white border-bottom border-white fw-semibold' : 'text-light' ?>">iPhone
                        12</a>
                </nav>
