            ...
            <div class="d-flex flex-column flex-md-row align-items-md-center justify-content-md-between gap-3">
                ...
                <nav class="d-flex overflow-auto gap-3">
                    <a href="ipad.php"
                        ...
                        cả</a>
                    <a href="?dong=airm3"
                        class="btn btn-sm border-0 pb-1 <?= $dong == 'airm3' ? 'text-white border-bottom border-white fw-semibold' : 'text-light' ?>">iPad
                        Air M3</a>
                    <a href="?dong=a16"
                        class="btn btn-sm border-0 pb-1 <?= $dong == 'a16' ? 'text-white border-bottom border-white fw-semibold' : 'text-light' ?>">iPad
                        A16</a>
                    <a href="?dong=prom4"
                        class="btn btn-sm border-0 pb-1 <?= $dong == 'prom4' ? 'text-white border-bottom border-white fw-semibold' : 'text-light' ?>">iPad
                        Pro M4</a>
                    <a href="?dong=airm2"
                        class="btn btn-sm border-0 pb-1 <?= $dong == 'airm2' ? 'text-white border-bottom border-white fw-semibold' : 'text-light' ?>">iPad
                        Air M2</a>
                    <a href="?dong=mini"
                        class="btn btn-sm border-0 pb-1 <?= $dong == 'mini' ? 'text-white border-bottom border-white fw-semibold' : 'text-light' ?>">iPad
                        mini</a>
                    <a href="?dong=9"
                        class="btn btn-sm border-0 pb-1 <?= $dong == '9' ? 'text-white border-bottom border-white fw-semibold' : 'text-light' ?>">iPad
                        9</a>
                    <a href="?dong=10"
                        class="btn btn-sm border-0 pb-1 <?= $dong == '10' ? 'text-white border-bottom border-white fw-semibold' : 'text-light' ?>">iPad
                        10</a>
                </nav>
                    ...
                    <a href="chi_tiet_san_pham.php?id=<?= $sp['id']; ?>" style="text-decoration: none; color: inherit;">
                        <div style="background-color: #323232; border-radius: 16px; padding: 20px; text-align: center; min-height: 480px;
                          transition: all 0.3s ease;"
                            ...
                            <img src="img/<?= htmlspecialchars($sp['ten_file']); ?>"
